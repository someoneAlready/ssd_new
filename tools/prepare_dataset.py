...
from dataset.psdb_ped import Psdb_Ped
...
def load_psdb_ped(image_set, dirname, shuffle=False, class_names = None):

    return Psdb_Ped(image_set, dirname, shuffle, is_train=True, class_names=class_names) 
...
if __name__ == '__main__':
    ...
    if args.dataset == 'pascal':
        ...
        db.save_imglist(args.target, root=args.root_path)
    elif args.dataset == 'psdb_ped':
        print(args.set)
        print(args.root_path)
        print(args.shuffle)
        db = load_psdb_ped(args.set, args.root_path, args.shuffle)
        db.save_imglist(args.target, root=args.root_path)
    else:
