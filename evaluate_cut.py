...
import os
import sys
from evaluate.evaluate_net_cut import evaluate_net
...
if __name__ == '__main__':
    ...
    print('args.rec_path={}'.format(args.rec_path))
    ...
    print('path_imglist={}'.format(args.list_path))
    print('nms_thresh={}'.format(args.nms_thresh))
    print('force_nms={}'.format(args.force_nms))
    print('ovp_thresh={}'.format(args.overlap_thresh))
    print('use_difficult={}'.format(args.use_difficult))
    print('class_names={}'.format(class_names))
    print('voc07_metric={}'.format(args.use_voc07_metric))
    print('frequent={}'.format(args.frequent))
