...
class DetRecordIter(mx.io.DataIter):
    ...
    def _get_batch(self):
        ...
        '''
        print self._batch.label[0][0,0]
        print self._batch.label[0][0,1]
        print self._batch.label[0][0,2]
        print self._batch.label[0][0,3]
        im = self._batch.data[0].asnumpy()[0].astype(float)
